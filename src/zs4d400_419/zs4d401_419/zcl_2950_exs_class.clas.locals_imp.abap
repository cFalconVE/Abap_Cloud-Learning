...
"! Flight Carrier
"! Transportistas de vuelo: una lógica de fábrica garantiza que solo haya
"! una sola instancia para el mismo identificador de transportista.
CLASS lcl_carrier DEFINITION CREATE PRIVATE.
  ...
  PUBLIC SECTION.
    ...
    "! Método de fábrica: devuelve una instancia de esta clase
    "! @parameter i_carrier_id | carrier_id - Identificación de tres caracteres del transportista.
    "! @parameter r_result | Referencia a la instancia: inicial si se produjo un error en la creación de instancias.
    "! @raising ZCX_2950_FAILED | Error de instanciación: evalúe el texto de excepción para obtener más detalles.
