...
CLASS lcl_passenger_flight DEFINITION .
  ...
  PRIVATE SECTION.
    ...
    CLASS-DATA: lt_connections_buffer TYPE TABLE OF st_connections_buffer.
...
CLASS lcl_passenger_flight IMPLEMENTATION.
  ...
  METHOD class_constructor.
    ...
    FIELDS carrier_id, connection_id,
      ...
      INTO TABLE @lt_connections_buffer.
...
* Set connection details
      ...
      connection_details = CORRESPONDING #( lt_connections_buffer[
